NEWSCHEMA('Vitrini').make(function(schema) {

    schema.define('productone', String, true);
    schema.define('producttwo', String, true);
    schema.define('productthree', String);
    schema.define('productfour', 'Object');
